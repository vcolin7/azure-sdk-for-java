...
import static com.azure.v2.core.util.tracing.Utils.SPAN_KIND_KEY;
import static com.azure.v2.core.util.tracing.Utils.START_TIME_KEY;
import static com.azure.v2.core.util.tracing.Utils.addMessagingAttributes;
import static com.azure.v2.core.util.tracing.Utils.getOrNull;
...
public interface Tracer {
    ...
    default Context getSharedSpanBuilder(String spanName, Context context) {
        ...
        SpanKind spanKind = getOrNull(context, SPAN_KIND_KEY, SpanKind.class);
        if (spanKind == null) {
