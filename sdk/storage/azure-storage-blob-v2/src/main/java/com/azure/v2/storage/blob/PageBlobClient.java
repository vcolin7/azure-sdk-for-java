...
import com.azure.v2.storage.blob.models.PageBlobsClearPagesHeaders;
import com.azure.v2.storage.blob.models.PageBlobsCopyIncrementalHeaders;
import com.azure.v2.storage.blob.models.PageBlobsCreateHeaders;
import com.azure.v2.storage.blob.models.PageBlobsGetPageRangesDiffHeaders;
import com.azure.v2.storage.blob.models.PageBlobsGetPageRangesHeaders;
import com.azure.v2.storage.blob.models.PageBlobsResizeHeaders;
import com.azure.v2.storage.blob.models.PageBlobsUpdateSequenceNumberHeaders;
import com.azure.v2.storage.blob.models.PageBlobsUploadPagesFromURLHeaders;
import com.azure.v2.storage.blob.models.PageBlobsUploadPagesHeaders;
...
public final class PageBlobClient {
    ...
    public Response<Void> createNoCustomHeadersWithResponse(String containerName, String blob, long contentLength,
        ...
        return this.serviceClient.createNoCustomHeadersWithResponse(containerName, blob, contentLength,
    ...
    public Response<Void> uploadPagesNoCustomHeadersWithResponse(String containerName, String blob, long contentLength,
        ...
        CpkInfo cpkInfo, EncryptionScope encryptionScopeParam, Context context) {
        return this.serviceClient.uploadPagesNoCustomHeadersWithResponse(containerName, blob, contentLength, body,
            transactionalContentMD5, transactionalContentCrc64, timeout, range, leaseId,
            ifSequenceNumberLessThanOrEqualTo, ifSequenceNumberLessThan, ifSequenceNumberEqualTo, ifModifiedSince,
            ifUnmodifiedSince, ifMatch, ifNoneMatch, ifTags, requestId, structuredBodyType, structuredContentLength,
            cpkInfo, encryptionScopeParam, context);
    ...
    public Response<Void> clearPagesNoCustomHeadersWithResponse(String containerName, String blob, long contentLength,
        ...
        OffsetDateTime ifUnmodifiedSince, String ifMatch, String ifNoneMatch, String ifTags, String requestId,
        CpkInfo cpkInfo, EncryptionScope encryptionScopeParam, Context context) {
        return this.serviceClient.clearPagesNoCustomHeadersWithResponse(containerName, blob, contentLength, timeout,
    ...
    public Response<Void> uploadPagesFromURLNoCustomHeadersWithResponse(String containerName, String blob,
        ...
        String sourceIfNoneMatch, String requestId, String copySourceAuthorization, CpkInfo cpkInfo,
        EncryptionScope encryptionScopeParam, Context context) {
        return this.serviceClient.uploadPagesFromURLNoCustomHeadersWithResponse(containerName, blob, sourceUrl,
    ...
    public ResponseBase<PageBlobsGetPageRangesHeaders, PageList> getPageRangesWithResponse(String containerName,
        ...
        return this.serviceClient.getPageRangesWithResponse(containerName, blob, snapshot, timeout, range, leaseId,
            ifModifiedSince, ifUnmodifiedSince, ifMatch, ifNoneMatch, ifTags, requestId, marker, maxresults, context);
    }
    ...
    public Response<PageList> getPageRangesNoCustomHeadersWithResponse(String containerName, String blob,
        ...
        OffsetDateTime ifUnmodifiedSince, String ifMatch, String ifNoneMatch, String ifTags, String requestId,
        String marker, Integer maxresults, Context context) {
        return this.serviceClient.getPageRangesNoCustomHeadersWithResponse(containerName, blob, snapshot, timeout,
    ...
    public ResponseBase<PageBlobsGetPageRangesDiffHeaders, PageList> getPageRangesDiffWithResponse(String containerName,
        ...
        return this.serviceClient.getPageRangesDiffWithResponse(containerName, blob, snapshot, timeout, prevsnapshot,
            ...
            requestId, marker, maxresults, context);
    }
    ...
    public Response<PageList> getPageRangesDiffNoCustomHeadersWithResponse(String containerName, String blob,
        ...
        return this.serviceClient.getPageRangesDiffNoCustomHeadersWithResponse(containerName, blob, snapshot, timeout,
    ...
    public Response<Void> resizeNoCustomHeadersWithResponse(String containerName, String blob, long blobContentLength,
        ...
        EncryptionScope encryptionScopeParam, Context context) {
        return this.serviceClient.resizeNoCustomHeadersWithResponse(containerName, blob, blobContentLength, timeout,
    ...
    public Response<Void> updateSequenceNumberNoCustomHeadersWithResponse(String containerName, String blob,
        ...
        return this.serviceClient.updateSequenceNumberNoCustomHeadersWithResponse(containerName, blob,
            sequenceNumberAction, timeout, leaseId, ifModifiedSince, ifUnmodifiedSince, ifMatch, ifNoneMatch, ifTags,
            blobSequenceNumber, requestId, context);
    }
    ...
    public Response<Void> copyIncrementalNoCustomHeadersWithResponse(String containerName, String blob,
        ...
        return this.serviceClient.copyIncrementalNoCustomHeadersWithResponse(containerName, blob, copySource, timeout,
