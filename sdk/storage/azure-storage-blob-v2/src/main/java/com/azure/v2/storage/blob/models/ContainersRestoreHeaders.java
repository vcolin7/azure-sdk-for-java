...
/**
 * The ContainersRestoreHeaders model.
 */
...
public final class ContainersRestoreHeaders {
    ...
    /**
     * Creates an instance of ContainersRestoreHeaders class.
     * 
     ...
     * @return the ContainersRestoreHeaders object itself.
     */
    public ContainersRestoreHeaders setXMsRequestId(String xMsRequestId) {
     ...
     * @return the ContainersRestoreHeaders object itself.
     */
    public ContainersRestoreHeaders setDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
            this.date = new DateTimeRfc1123(date);
