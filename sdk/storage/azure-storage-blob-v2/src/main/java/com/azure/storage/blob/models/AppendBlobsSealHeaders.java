...
/**
 * The AppendBlobsSealHeaders model.
 */
@Fluent
public final class AppendBlobsSealHeaders {
    ...
    /**
     * Creates an instance of AppendBlobsSealHeaders class.
     * 
     ...
     * @return the AppendBlobsSealHeaders object itself.
     */
    public AppendBlobsSealHeaders setLastModified(OffsetDateTime lastModified) {
        if (lastModified == null) {
     ...
     * @return the AppendBlobsSealHeaders object itself.
     */
    public AppendBlobsSealHeaders setXMsRequestId(String xMsRequestId) {
     ...
     * @return the AppendBlobsSealHeaders object itself.
     */
    public AppendBlobsSealHeaders setDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
            this.date = new DateTimeRfc1123(date);
