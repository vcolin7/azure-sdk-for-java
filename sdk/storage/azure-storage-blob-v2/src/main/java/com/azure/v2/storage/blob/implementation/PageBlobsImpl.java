...
public final class PageBlobsImpl {
    ...
    public interface PageBlobsService {
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 201 })
        @UnexpectedResponseExceptionDetail(exceptionBodyClass = StorageError.class)
        Response<Void> uploadPages(@HostParam("url") String url, @PathParam("containerName") String containerName,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 201 })
        @UnexpectedResponseExceptionDetail(exceptionBodyClass = StorageError.class)
        Response<Void> clearPages(@HostParam("url") String url, @PathParam("containerName") String containerName,
            @PathParam("blob") String blob, @QueryParam("comp") String comp,
            @HeaderParam("x-ms-page-write") String pageWrite, @HeaderParam("Content-Length") long contentLength,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 201 })
        @UnexpectedResponseExceptionDetail(exceptionBodyClass = StorageError.class)
        default void clearPages(@HostParam("url") String url, @PathParam("containerName") String containerName,
            @PathParam("blob") String blob, @QueryParam("comp") String comp,
            @HeaderParam("x-ms-page-write") String pageWrite, @HeaderParam("Content-Length") long contentLength,
            @HeaderParam("x-ms-version") String version, @HeaderParam("Accept") String accept) {
            clearPages(url, containerName, blob, comp, pageWrite, contentLength, null, null, null, null, null, null,
                null, null, null, null, null, null, null, null, null, version, null, accept, null);
        }
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 201 })
        @UnexpectedResponseExceptionDetail(exceptionBodyClass = StorageError.class)
        Response<Void> uploadPagesFromURL(@HostParam("url") String url,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 201 })
        @UnexpectedResponseExceptionDetail(exceptionBodyClass = StorageError.class)
        default void uploadPagesFromURL(@HostParam("url") String url, @PathParam("containerName") String containerName,
            @PathParam("blob") String blob, @QueryParam("comp") String comp,
            @HeaderParam("x-ms-page-write") String pageWrite, @HeaderParam("x-ms-copy-source") String sourceUrl,
            @HeaderParam("x-ms-source-range") String sourceRange, @HeaderParam("Content-Length") long contentLength,
            @HeaderParam("x-ms-range") String range, @HeaderParam("x-ms-version") String version,
            @HeaderParam("Accept") String accept) {
            uploadPagesFromURL(url, containerName, blob, comp, pageWrite, sourceUrl, sourceRange, null, null,
                contentLength, null, range, null, null, null, null, null, null, null, null, null, null, null, null,
                null, null, null, null, null, version, null, null, accept, null);
        }
        ...
        @UnexpectedResponseExceptionDetail(exceptionBodyClass = StorageError.class)
        Response<PageList> getPageRanges(@HostParam("url") String url, @PathParam("containerName") String containerName,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail(exceptionBodyClass = StorageError.class)
        default PageList getPageRanges(@HostParam("url") String url, @PathParam("containerName") String containerName,
            @PathParam("blob") String blob, @QueryParam("comp") String comp,
            @HeaderParam("x-ms-version") String version, @HeaderParam("Accept") String accept) {
            return getPageRanges(url, containerName, blob, comp, null, null, null, null, null, null, null, null, null,
                version, null, null, null, accept, null).getValue();
        }
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail(exceptionBodyClass = StorageError.class)
        default PageList getPageRangesDiff(@HostParam("url") String url,
            @PathParam("containerName") String containerName, @PathParam("blob") String blob,
            @QueryParam("comp") String comp, @HeaderParam("x-ms-version") String version,
            @HeaderParam("Accept") String accept) {
            return getPageRangesDiff(url, containerName, blob, comp, null, null, null, null, null, null, null, null,
                null, null, null, version, null, null, null, accept, null).getValue();
        }
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail(exceptionBodyClass = StorageError.class)
        Response<Void> resize(@HostParam("url") String url, @PathParam("containerName") String containerName,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail(exceptionBodyClass = StorageError.class)
        default void resize(@HostParam("url") String url, @PathParam("containerName") String containerName,
            @PathParam("blob") String blob, @QueryParam("comp") String comp,
            @HeaderParam("x-ms-blob-content-length") long blobContentLength,
            @HeaderParam("x-ms-version") String version, @HeaderParam("Accept") String accept) {
            resize(url, containerName, blob, comp, null, null, null, null, null, null, null, null, null, null, null,
                blobContentLength, version, null, accept, null);
        }
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail(exceptionBodyClass = StorageError.class)
        default void updateSequenceNumber(@HostParam("url") String url,
            @PathParam("containerName") String containerName, @PathParam("blob") String blob,
            @QueryParam("comp") String comp,
            @HeaderParam("x-ms-sequence-number-action") SequenceNumberActionType sequenceNumberAction,
            @HeaderParam("x-ms-version") String version, @HeaderParam("Accept") String accept) {
            updateSequenceNumber(url, containerName, blob, comp, null, null, null, null, null, null, null,
                sequenceNumberAction, null, version, null, accept, null);
        }
        ...
        @UnexpectedResponseExceptionDetail(exceptionBodyClass = StorageError.class)
        Response<Void> copyIncremental(@HostParam("url") String url, @PathParam("containerName") String containerName,
            @PathParam("blob") String blob, @QueryParam("comp") String comp, @QueryParam("timeout") Integer timeout,
            @HeaderParam("If-Modified-Since") DateTimeRfc1123 ifModifiedSince,
            @HeaderParam("If-Unmodified-Since") DateTimeRfc1123 ifUnmodifiedSince,
            @HeaderParam("If-Match") String ifMatch, @HeaderParam("If-None-Match") String ifNoneMatch,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 202 })
        @UnexpectedResponseExceptionDetail(exceptionBodyClass = StorageError.class)
        default void copyIncremental(@HostParam("url") String url, @PathParam("containerName") String containerName,
            @PathParam("blob") String blob, @QueryParam("comp") String comp,
            @HeaderParam("x-ms-copy-source") String copySource, @HeaderParam("x-ms-version") String version,
            @HeaderParam("Accept") String accept) {
            copyIncremental(url, containerName, blob, comp, null, null, null, null, null, null, copySource, version,
                null, accept, null);
        }
    }
    ...
    public Response<Void> createWithResponse(String containerName, String blob, long contentLength,
        ...
        return service.create(this.client.getUrl(), containerName, blob, blobType, timeout, contentLength, tier,
            ...
            immutabilityPolicyMode, legalHold, accept, requestOptions);
    }
    ...
    public void create(String containerName, String blob, long contentLength, long blobContentLength, Integer timeout,
        ...
        createWithResponse(containerName, blob, contentLength, blobContentLength, timeout, tier, metadata, leaseId,
            ...
            encryptionScopeParam, RequestOptions.none());
    }
    ...
    public Response<Void> uploadPagesWithResponse(String containerName, String blob, long contentLength,
        ...
        return service.uploadPages(this.client.getUrl(), containerName, blob, comp, pageWrite, contentLength,
            ...
            ifMatch, ifNoneMatch, ifTags, this.client.getVersion(), requestId, structuredBodyType,
            structuredContentLength, body, accept, requestOptions);
    }
    ...
    public Response<Void> uploadPagesFromURLWithResponse(String containerName, String blob, String sourceUrl,
        ...
        return service.uploadPagesFromURL(this.client.getUrl(), containerName, blob, comp, pageWrite, sourceUrl,
            ...
            this.client.getVersion(), requestId, copySourceAuthorization, accept, requestOptions);
    }
    ...
    public void uploadPagesFromURL(String containerName, String blob, String sourceUrl, String sourceRange,
        ...
        uploadPagesFromURLWithResponse(containerName, blob, sourceUrl, sourceRange, contentLength, range,
            ...
            copySourceAuthorization, cpkInfo, encryptionScopeParam, RequestOptions.none());
    }
    ...
    public Response<PageList> getPageRangesWithResponse(String containerName, String blob, String snapshot,
        ...
        return service.getPageRanges(this.client.getUrl(), containerName, blob, comp, snapshot, timeout, range, leaseId,
            ifModifiedSinceConverted, ifUnmodifiedSinceConverted, ifMatch, ifNoneMatch, ifTags,
            this.client.getVersion(), requestId, marker, maxresults, accept, requestOptions);
    }
    ...
    public PageList getPageRanges(String containerName, String blob, String snapshot, Integer timeout, String range,
        ...
        return getPageRangesWithResponse(containerName, blob, snapshot, timeout, range, leaseId, ifModifiedSince,
            ifUnmodifiedSince, ifMatch, ifNoneMatch, ifTags, requestId, marker, maxresults, RequestOptions.none())
                .getValue();
    }
    ...
    public Response<PageList> getPageRangesDiffWithResponse(String containerName, String blob, String snapshot,
        ...
        return service.getPageRangesDiff(this.client.getUrl(), containerName, blob, comp, snapshot, timeout,
            ...
            ifMatch, ifNoneMatch, ifTags, this.client.getVersion(), requestId, marker, maxresults, accept,
            requestOptions);
    }
    ...
    public PageList getPageRangesDiff(String containerName, String blob, String snapshot, Integer timeout,
        ...
        return getPageRangesDiffWithResponse(containerName, blob, snapshot, timeout, prevsnapshot, prevSnapshotUrl,
            ...
            maxresults, RequestOptions.none()).getValue();
    }
    ...
    public Response<Void> updateSequenceNumberWithResponse(String containerName, String blob,
        ...
        return service.updateSequenceNumber(this.client.getUrl(), containerName, blob, comp, timeout, leaseId,
            ...
            blobSequenceNumber, this.client.getVersion(), requestId, accept, requestOptions);
    }
    ...
    public void updateSequenceNumber(String containerName, String blob, SequenceNumberActionType sequenceNumberAction,
        ...
        updateSequenceNumberWithResponse(containerName, blob, sequenceNumberAction, timeout, leaseId, ifModifiedSince,
            ifUnmodifiedSince, ifMatch, ifNoneMatch, ifTags, blobSequenceNumber, requestId, RequestOptions.none());
    }
    ...
    public void copyIncremental(String containerName, String blob, String copySource, Integer timeout,
        ...
        copyIncrementalWithResponse(containerName, blob, copySource, timeout, ifModifiedSince, ifUnmodifiedSince,
            ifMatch, ifNoneMatch, ifTags, requestId, RequestOptions.none());
    }
}
