...
public final class BlockBlobsStageBlockFromURLHeaders {
     ...
     * @return the BlockBlobsStageBlockFromURLHeaders object itself.
     */
    public BlockBlobsStageBlockFromURLHeaders setXMsContentCrc64(byte[] xMsContentCrc64) {
     ...
     * @return the BlockBlobsStageBlockFromURLHeaders object itself.
     */
    public BlockBlobsStageBlockFromURLHeaders setXMsRequestId(String xMsRequestId) {
     ...
     * @return the BlockBlobsStageBlockFromURLHeaders object itself.
     */
    public BlockBlobsStageBlockFromURLHeaders setDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
            this.date = new DateTimeRfc1123(date);
     ...
     * @return the BlockBlobsStageBlockFromURLHeaders object itself.
     */
    public BlockBlobsStageBlockFromURLHeaders setXMsEncryptionScope(String xMsEncryptionScope) {
