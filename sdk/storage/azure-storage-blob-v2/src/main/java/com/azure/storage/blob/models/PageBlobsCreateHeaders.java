...
public final class PageBlobsCreateHeaders {
     ...
     */
    public PageBlobsCreateHeaders(HttpHeaders rawHeaders) {
     ...
     */
    public PageBlobsCreateHeaders setXMsVersion(String xMsVersion) {
     ...
     * @return the PageBlobsCreateHeaders object itself.
     */
    public PageBlobsCreateHeaders setETag(String eTag) {
        this.eTag = eTag;
        return this;
    }
     ...
     * @return the PageBlobsCreateHeaders object itself.
     */
    public PageBlobsCreateHeaders setLastModified(OffsetDateTime lastModified) {
        if (lastModified == null) {
     ...
     * @return the PageBlobsCreateHeaders object itself.
     */
    public PageBlobsCreateHeaders setXMsVersionId(String xMsVersionId) {
     ...
     * @return the PageBlobsCreateHeaders object itself.
     */
    public PageBlobsCreateHeaders setXMsEncryptionKeySha256(String xMsEncryptionKeySha256) {
     ...
     * @return the PageBlobsCreateHeaders object itself.
     */
    public PageBlobsCreateHeaders setXMsRequestId(String xMsRequestId) {
     ...
     * @return the PageBlobsCreateHeaders object itself.
     */
    public PageBlobsCreateHeaders setXMsRequestServerEncrypted(Boolean xMsRequestServerEncrypted) {
     ...
     * @return the PageBlobsCreateHeaders object itself.
     */
    public PageBlobsCreateHeaders setXMsClientRequestId(String xMsClientRequestId) {
     ...
     * @return the PageBlobsCreateHeaders object itself.
     */
    public PageBlobsCreateHeaders setDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
            this.date = new DateTimeRfc1123(date);
     ...
     * @return the PageBlobsCreateHeaders object itself.
     */
    public PageBlobsCreateHeaders setContentMD5(byte[] contentMD5) {
     ...
     * @return the PageBlobsCreateHeaders object itself.
     */
    public PageBlobsCreateHeaders setXMsEncryptionScope(String xMsEncryptionScope) {
