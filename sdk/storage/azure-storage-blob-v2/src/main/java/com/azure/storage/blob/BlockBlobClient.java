...
import com.azure.storage.blob.models.BlockBlobsCommitBlockListHeaders;
import com.azure.storage.blob.models.BlockBlobsGetBlockListHeaders;
import com.azure.storage.blob.models.BlockBlobsPutBlobFromUrlHeaders;
import com.azure.storage.blob.models.BlockBlobsStageBlockFromURLHeaders;
import com.azure.storage.blob.models.BlockBlobsStageBlockHeaders;
import com.azure.storage.blob.models.BlockBlobsUploadHeaders;
...
public final class BlockBlobClient {
    ...
    public Response<Void> uploadNoCustomHeadersWithResponse(String containerName, String blob, long contentLength,
        ...
        return this.serviceClient.uploadNoCustomHeadersWithResponse(containerName, blob, contentLength, body, timeout,
            transactionalContentMD5, metadata, leaseId, tier, ifModifiedSince, ifUnmodifiedSince, ifMatch, ifNoneMatch,
            ifTags, requestId, blobTagsString, immutabilityPolicyExpiry, immutabilityPolicyMode, legalHold,
            transactionalContentCrc64, structuredBodyType, structuredContentLength, blobHttpHeaders, cpkInfo,
            encryptionScopeParam, context);
    ...
    public Response<Void> putBlobFromUrlNoCustomHeadersWithResponse(String containerName, String blob,
        ...
        Boolean copySourceBlobProperties, String copySourceAuthorization, BlobCopySourceTagsMode copySourceTags,
        BlobHttpHeaders blobHttpHeaders, CpkInfo cpkInfo, EncryptionScope encryptionScopeParam, Context context) {
        return this.serviceClient.putBlobFromUrlNoCustomHeadersWithResponse(containerName, blob, contentLength,
    ...
    public ResponseBase<BlockBlobsStageBlockHeaders, Void> stageBlockWithResponse(String containerName, String blob,
        ...
        return this.serviceClient.stageBlockWithResponse(containerName, blob, blockId, contentLength, body,
            ...
            structuredContentLength, cpkInfo, encryptionScopeParam, context);
    }
    ...
    public Response<Void> stageBlockNoCustomHeadersWithResponse(String containerName, String blob, String blockId,
        ...
        return this.serviceClient.stageBlockNoCustomHeadersWithResponse(containerName, blob, blockId, contentLength,
            body, transactionalContentMD5, transactionalContentCrc64, timeout, leaseId, requestId, structuredBodyType,
            structuredContentLength, cpkInfo, encryptionScopeParam, context);
    }
    ...
    public Response<Void> stageBlockFromURLNoCustomHeadersWithResponse(String containerName, String blob,
        ...
        OffsetDateTime sourceIfUnmodifiedSince, String sourceIfMatch, String sourceIfNoneMatch, String requestId,
        String copySourceAuthorization, CpkInfo cpkInfo, EncryptionScope encryptionScopeParam, Context context) {
        return this.serviceClient.stageBlockFromURLNoCustomHeadersWithResponse(containerName, blob, blockId,
    ...
    public Response<Void> commitBlockListNoCustomHeadersWithResponse(String containerName, String blob,
        ...
        BlobImmutabilityPolicyMode immutabilityPolicyMode, Boolean legalHold, BlobHttpHeaders blobHttpHeaders,
        CpkInfo cpkInfo, EncryptionScope encryptionScopeParam, Context context) {
        return this.serviceClient.commitBlockListNoCustomHeadersWithResponse(containerName, blob, blocks, timeout,
            transactionalContentMD5, transactionalContentCrc64, metadata, leaseId, tier, ifModifiedSince,
            ifUnmodifiedSince, ifMatch, ifNoneMatch, ifTags, requestId, blobTagsString, immutabilityPolicyExpiry,
            immutabilityPolicyMode, legalHold, blobHttpHeaders, cpkInfo, encryptionScopeParam, context);
    }
    ...
    public Response<BlockList> getBlockListNoCustomHeadersWithResponse(String containerName, String blob,
        ...
        Context context) {
        return this.serviceClient.getBlockListNoCustomHeadersWithResponse(containerName, blob, listType, snapshot,
            timeout, leaseId, ifTags, requestId, context);
    }
}
