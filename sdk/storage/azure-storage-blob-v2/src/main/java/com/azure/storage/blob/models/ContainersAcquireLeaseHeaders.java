...
/**
 * The ContainersAcquireLeaseHeaders model.
 */
@Fluent
public final class ContainersAcquireLeaseHeaders {
    /*
    ...
    /**
     * Creates an instance of ContainersAcquireLeaseHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public ContainersAcquireLeaseHeaders(HttpHeaders rawHeaders) {
     ...
     */
    public ContainersAcquireLeaseHeaders setXMsVersion(String xMsVersion) {
     ...
     * @return the ContainersAcquireLeaseHeaders object itself.
     */
    public ContainersAcquireLeaseHeaders setETag(String eTag) {
        this.eTag = eTag;
        return this;
    }
     ...
     * @return the ContainersAcquireLeaseHeaders object itself.
     */
    public ContainersAcquireLeaseHeaders setXMsLeaseId(String xMsLeaseId) {
     ...
     * @return the ContainersAcquireLeaseHeaders object itself.
     */
    public ContainersAcquireLeaseHeaders setLastModified(OffsetDateTime lastModified) {
        if (lastModified == null) {
     ...
     * @return the ContainersAcquireLeaseHeaders object itself.
     */
    public ContainersAcquireLeaseHeaders setXMsRequestId(String xMsRequestId) {
     ...
     * @return the ContainersAcquireLeaseHeaders object itself.
     */
    public ContainersAcquireLeaseHeaders setXMsClientRequestId(String xMsClientRequestId) {
     ...
     * @return the ContainersAcquireLeaseHeaders object itself.
     */
    public ContainersAcquireLeaseHeaders setDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
            this.date = new DateTimeRfc1123(date);
